...
class Generator:
    def __init__(self,k=64,n_res=9):
        ...
        u128 = Conv2DTranspose(128,(3,3),(2,2))(u128)
        u128 = InstanceNormalization()(u128)
        u128 = ReLU()(u128)

        u64 = ReflectionPadding2D()(u128)
        u64 = Conv2DTranspose(64,(3,3),(2,2))(u64)
        u64 = InstanceNormalization()(u64)
        u64 = ReLU()(u64)

        c7s13 = ReflectionPadding2D()(u64)
        c7s13 = Conv2D(3,(7,7),(1,1))(c7s13)
